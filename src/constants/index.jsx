export const features = [
  {
    ...
    caption: "Γρηγορη Εξυπηρέτηση",
    title: "Πιο γρήγορα, αλλά πιο ποιοτικά",
    text: "Μπορούμε να παρέχουμε γρήγορη εξυπηρέτηση λόγο του εύελικτου προγράμματος μας, εφόσον η ομάδα μας αποτελείτε αποκλειστικά από φοιτητές που ζούν Θεσσαλονίκη.",
    button: {
  ...
  },
  {
    ...
    caption: "Ασφαλεια & Εμπιστοσυνη",
    title: "Μεν εσχείς έννοια, άηστο πάνω μας",
    text: "Σαν φοιτητές και εμείς αντιλαμβανόμαστε ότι είναι δύσκολο να εμπειστευτείς τα προσωπικά σου αντικείμενα σε ξένα χέρια, γι'αυτό χειριζόμαστε την κάθε περίπτωση με πλήρη σεβασμό και προσοχή.",
    button: {
...
export const details = [
  {
    ...
    title: "Συναρμολoγηση PC",
  },
  {
    id: "1",
    icon: "/images/detail-2.png",
    title: "Εγκατασταση προγραμματων",
  },
  {
    id: "2",
    icon: "/images/detail-3.png",
    title: "Συντηρηση υπολογιστη",
  },
  {
    id: "3",
    icon: "/images/detail-4.png",
    title: "24 / 7 ψυχικη υποστηριξη για υπολογιστες",
  },
];
...
export const faq = [
  {
    id: "0",
    question: "Τι ώρα μπόρω νας σας πιάσω τηλέφωνο;",
    answer: "Ότι ώρα θέλεις. Εν εγγυούμαστεν ότι ενα είμαστεν όξυπνοι!",
  },
  {
    id: "1",
    question: "Σάζετε τζαι MacBook;",
    answer: "Εεεεεεε.. ΟΙ.",
  },
  {
    id: "2",
    question: "Πού μπόρουμεν να σας έβρουμεν;",
    answer: "Έν θα μας έβρετε. Ενα σας έβρουμεν εμείς ;)",
  },
  {
    id: "3",
    question: "Διάτε αποζημίωση σε περίπτωση ζημιάς απο εσάς;",
    answer: "Εμπρός καλά μου πόδια.",
  },
];
...
export const plans = [
  {
    ...
    priceMonthly: 12,
    priceYearly: 19,
    caption: "Συναρμολόγηση PC",
    features: [
      "Συναρμολόγηση Hardware",
      "Εγκατάσταση Windows/Linux",
      "Έλεγχος βλαβών",
  ...
  },
  {
    ...
    priceMonthly: 59,
    priceYearly: 79,
    caption: "Συντήρηση Υπολογιστή",
    features: [
      "Έλεγχος για ιούς",
      "Καθαρισμός αχρείαστων αρχείων",
      "Αναβάθμιση λογισμικών",
    ],
  ...
  },
  {
    ...
    priceMonthly: 29,
    priceYearly: 39,
    caption: "Εγκατάσταση Λογισμικών",
    features: [
      "Έλεγχος ασφάλειας λογισμικού",
      "Εγκατάσταση επι πληρωμή εφαρμογών δωρεάν",
      "Ρύθμιση προβληματικών λογισμικών",
    ],
...
export const testimonials = [
  {
    id: "0",
    name: "Άγγελος Καλούτσης",
    role: "Εφαρμοσμενος Φοιτητης Πληροφορικης",
    avatarUrl: "/images/testimonials/kaloutsis.png",
    comment:
      "Κοιμάτι όπου βρει και όπου σταθεί. Αρχιτεκτονική θα χρωστά μια ζωή. Μπορεί να χακάρει κάθε συσκευή.",
  },
  {
    id: "1",
    name: "Περικλής Σωτηρέλης",
    role: "Επαγγελματιας Φοιτητής Πληροφορικης",
    avatarUrl: "/images/testimonials/periklis.png",
    comment:
      "Σπάει τα πάντα με μια γροθιά. Τρώει τα πάντα με μια μπουκια. Φτιάχνει τα πάντα με μια χαρά.",
  },
  {
    id: "2",
    name: "Σαμουήλ Πρατζιώτης",
    role: "Φαλακρός Φοιτητής Πληροφορικής",
    avatarUrl: "/images/testimonials/pratziotis.png",
    comment:
      "Χάνει τις τρίχες στο λεπτό. Έχει μια μύτη σαν βουνό. Ξέρει πράγματα ένα σωρό.",
  },
];
